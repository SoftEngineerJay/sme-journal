...
import jay.smejournal.Models.Category.Category;
import jay.smejournal.Models.Category.CategoryService;
import jay.smejournal.Models.Product.Product;
import jay.smejournal.Models.Product.ProductService;
...
public class ProductController {
    ...
    public String findAll(Model model){
        ...
        return "views/modules/product/index";
    }
    ...
    public String addProduct(Model model, Product product){
        ...
        return "views/modules/product/create";
    }
    ...
    public String updateProduct(@PathVariable(value = "id") Long id, Model model) {
        ...
        return "views/modules/product/update";
    }
